...
@Component({
  selector: 'app-admin-jawa',
  templateUrl: './admin-jawa.component.html',
  styleUrls: ['./admin-jawa.component.css']
})
export class AdminJawaComponent implements OnInit {
  ...
  loadResepList(){
    this.http.get("http://localhost:3000/api/resep/jawa")
    .subscribe(
      result => {
